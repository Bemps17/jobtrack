/* ═══════════════════════════════════════════════════════════════════════
   JOBTRACK — app.js (CORRIGÉ & AMÉLIORÉ)
   Modules : Config · State · Data · Utils · Render · Views · Events · Import
═══════════════════════════════════════════════════════════════════════ */
...
/** Finalise l'import après résolution des doublons */
function finalizeImport() {
  if (State.pendingImport.length === 0) return;
...
function bindEvents() {
  ...
  if (burger) {
    burger.addEventListener('click', openMobileSidebar);
  } else {
    console.warn('Element #burger not found');
  }
  ...
  console.log('Events bound successfully'); // Debug
}
